...
df = pd.read_csv('result1_std_val_days.csv')
...
write.to_csv("rf1_val_days.csv", encoding="utf-8")

df2 = pd.read_csv('result2_std_val_days.csv')
...
result2.to_csv("rf2_val_days.csv", encoding="utf-8")