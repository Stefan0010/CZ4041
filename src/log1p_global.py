...
rf.fit(toWrite[:tr, :], log[:tr].ravel())
...
df.to_csv('result1_log_global.csv', index=False)
...
rf2.fit(toWrite[:tr2,:], log[:tr2].ravel())
...
df2.to_csv('result2_log_global.csv', index=False)
